...
namespace PurgeOldXInput
{
    ...
    internal static class NativeMethods
    {
        ...
        [DllImport("setupapi.dll", CharSet = CharSet.Auto, EntryPoint = "SetupDiOpenDeviceInfoW", SetLastError = true)]
        static internal extern bool SetupDiOpenDeviceInfo(IntPtr deviceInfoSet, string deviceInstanceId, IntPtr parent, int flags, IntPtr deviceInfoData);
